...
def export_accounts_to_json():
    ...
    # Write to JSON file - try different possible paths
    ...
    if not output_file:
        output_file = "accounts.json"  # Fallback to current directory
        print(f"⚠️ Using fallback output path: {output_file}")
